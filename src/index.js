...
const adminInitializer = require('./infrastructure/database/adminInitializer');
const authenticate = require('./interface/middlewares/authenticate');
const authorizeLevel2 = require('./interface/middlewares/authorizeLevel2');
...
server.get('/crudtarefas.html', authenticate, authorizeLevel2, (req, res) => {
